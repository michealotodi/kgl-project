...
urlpatterns = [
    ...
    path('reports/matugga-daily/', views.matugga_daily_sales_report, name='matugga_daily_sales_report'),
    path('reports/maganjo-daily/', views.maganjo_daily_sales_report, name='magganjo_daily_sales_report'),
    ...
    path(
        "branch-comparison/",
        views.branch_comparison_dashboard,
        name="branch_comparison_dashboard",
    ),
    path(
        "credit-recovery-report/",
        views.credit_recovery_report,
        name="credit_recovery_report",
    ),
    path(
    ...
    path(
        "dashboard/sales-agent/matugga/",
        views.sales_agent_dashboard_matugga,
        name="sales_agent_dashboard_matugga",
    ),
    path(
        "dashboard/sales-agent/maganjo/",
        views.sales_agent_dashboard_maganjo,
        name="sales_agent_dashboard_maganjo",
    ),
    path("sale/<int:pk>/", views.sale_detail, name="sale_detail"),
    path(
        "sale/<int:sale_id>/receipt/", views.generate_receipt, name="generate_receipt"
    ),
    path(
        "sales/branch/<str:branch_name>/", views.sales_by_branch, name="sales_by_branch"
    ),
    path(
        "manager/matugga/",
        views.manager_dashboard_matugga,
        name="manager_dashboard_matugga",
    ),
    path(
        "manager/maganjo/",
        views.manager_dashboard_maganjo,
        name="manager_dashboard_maganjo",
    ),
    path(
        "salesagent/matugga/",
        views.sales_agent_dashboard_matugga,
